...
class Index extends Component
{
    ...
    public function create()
    {
        ...
        $this->reset([
            'name', 
            'nomenclature_id_1', 'nature_1', 
            'nomenclature_id_2', 'nature_2', 
            'nomenclature_id_3', 'nature_3',
            'nomenclature_id_4', 'nature_4',
            'nomenclature_id_5', 'nature_5',
            'nomenclature_id_6', 'nature_6',
            'ruleId'
        ]);
    ...
    {
        $rules = AccountingRule::with(['nomenclature1', 'nomenclature2', 'nomenclature3', 'nomenclature4', 'nomenclature5', 'nomenclature6'])
